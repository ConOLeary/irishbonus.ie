...
switch ($subject) {
	case "Stair":
	case "Fisic":
	case "Eolaíocht (ts amháin)":
	case "Laidin":
	case "Gréigis":
	case "Staidéar Clasaiceach":
	case "Staidéar Eabhrais":
	case "Tír Eolaíocht":
	case "Ceimic":
	case "Fisic agus Ceimic":
	case "Bitheolaíocht":
	case "Gnó (ts amháin)":
	case "Eacnamaíocht":
	case "Stair Eacnamaíochta":
	case "Eolaíocht Talmhaíochta":
	case "Eacnamaíocht Talmhaíochta":
	case "Eacnamaíocht Bhaile":
	case "Ceol":
	case "Staidéar Gnó":
	case "Léirthuiscint na hEalaíne":
	case "Civic (ts amháin)":
	case "Oideachas Saoránáioch Sóisialta":
	case "Teagasc Reiligiúin":
	case "Araibic":
	case "LCVP Link Modules":
		$bonusgroup = 1;
		break;
	case "Fraincis":
	case "Gearmáinis":
	...
	case "Spáinnis":
	case "Matamaitic":
	case "Matamaitic Fheidhmeach":
	case "Cuntasaíocht":
	case "Innealtóireacht":
	case "Staidéar Foirgníochta":
	case "Teicneolaiocht Ábhar (Adhmad) (ts amháin)":
	case "Miotalóireacht (ts amháin)":
	case "Teicneolaíocht Teastas Sóisearach (ts amháin)":
	case "Teicneolaíocht an Ardteistiméireacht":
	case "Clóscríobh (ts amháin)":
	case "Rúsaigh":
	case "Seapáinis":
		$bonusgroup = 2;
		break;
	case "Ealaín (ts amháin)":
	case "Ceird":
	case "Dearadh (ts amháin)":
		$bonusgroup = 3;
		break;
}
...
<div align= 'center'>
<p style="color:green; font-size:30px;"><strong>Bónas Gaeilge</strong></h1>
<div id="text2" style="font-size: 17px;">
<p>Cuireann an t-áireamhán bónas Gaeilge na marcanna a fuair tú tríd an scrúdú a dhéanamh </p>
<p>trí mheán na Gaeilge in áireamh agus léiríonn sé duit an grád a bhaintear amach </p>
<p>leis agus gan na marcanna breise a chur le do chuid torthaí.</p>
</div>
<br>
<div id="text" style="font-size: 20px;">
<p>Roghnaigh d'ábhar as an liosta thíos. </p>
<p>Cuir do mharc isteach agus brú an cnaipe. </p>
</div>
<br>
<form action="" method="post">
<strong>   Roghnaigh Ábhair:</strong>
<select name="formSubject" class="dropdown">
  <option value=">>>">">>>"</option>
  <option value="Araibic">Araibic</option>
  <option value="Bitheolaíocht">Bitheolaíocht</option>
  <option value="Ceimic">Ceimic</option>
  <option value="Ceird">Ceird</option>
  <option value="Ceol">Ceol</option>
  <option value="Civic (ts amháin)">Civic (ts amháin)</option>
  <option value="Clóscríobh (ts amháin)">Clóscríobh (ts amháin)</option>
  <option value="Cuntasaíocht">Cuntasaíocht</option>
  <option value="Dearadh (ts amháin)">Dearadh (ts amháin)</option>
  <option value="Eacnamaíocht">Eacnamaíocht</option>
  <option value="Ealaín (ts amháin)">Ealaín (ts amháin)</option>
  <option value="Eolaíocht Talmhaíochta">Eolaíocht Talmhaíochta</option>
  <option value="Eacnamaíocht Talmhaíochta">Eacnamaíocht Talmhaíochta</option>
  <option value="Eacnamaíocht Bhaile">Eacnamaíocht Bhaile</option>
  <option value="Eolaíocht (ts amháin)">Eolaíocht (ts amháin)</option>
  <option value="Fraincis">Fraincis</option>
  <option value="Fisic">Fisic</option>
  <option value="Fisic agus Ceimic">Fisic agus Ceimic</option>
  <option value="Gearmáinis">Gearmáinis</option>
  <option value="Gréigis">Gréigis</option>
  <option value="Gnó (ts amháin)">Gnó (ts amháin)</option>
  <option value="Iodáilis">Iodáilis</option>
  <option value="Innealtóireacht">Innealtóireacht</option>
  <option value="Laidin">Laidin</option>
  <option value="Léirthuiscint na hEalaíne">Léirthuiscint na hEalaíne</option>
  <option value="LCVP Link Modules">LCVP Link Modules</option>
  <option value="Matamaitic">Matamaitic</option>
  <option value="Matamaitic Fheidhmeach">Matamaitic Fheidhmeach</option>
  <option value="Miotalóireacht (ts amháin)">Miotalóireacht (ts amháin)</option>
  <option value="Oideachas Saoránáioch Sóisialta">Oideachas Saoránáioch Sóisialta</option>
  <option value="Rúsaigh">Rúsaigh</option>
  <option value="Seapáis">Seapáinis</option>
  <option value="Spáinnis">Spáinnis</option>
  <option value="Stair Eacnamaíochta">Stair Eacnamaíochta</option>
  <option value="Staidéar Gnó">Staidéar Gnó</option>
  <option value="Stair">Stair</option>
  <option value="Staidéar Clasaiceach">Staidéar Clasaiceach</option>
  <option value="Staidéar Eabhrais">Staidéar Eabhrais</option>
  <option value="Staidéar Foirgníochta">Staidéar Foirgníochta</option>
  <option value="Teagasc Reiligiúin">Teagasc Reiligiúin</option>
  <option value="Teicneolaiocht Ábhar (Adhmad) (ts amháin)">Teicneolaiocht Ábhar (Adhmad) (ts amháin)</option>
  <option value="Teicneolaíocht Teastas Sóisearach (ts amháin)">Teicneolaíocht Teastas Sóisearach (ts amháin)</option>
  <option value="Teinneolaíocht an Ardteistiméireacht">Teinneolaíocht an Ardteistiméireacht</option>
  <option value="Tír Eolaíocht">Tír Eolaíocht</option>
</select>

<table width="300px">
<tr>
<td valign="top">
<strong>Ionchur Marc:</strong>
...
<table border="1" width="450px" bgcolor="white">
	<tr>
		...
		<th height="30">Bunaidh</th>
		<th height="30">Bónas Gaeilge</th>
		<th height="30" style="color: green">Iomlán</th>
	</tr>
	<tr>
		<td height="30"><strong>Marc</strong></td>
...
<br>
<br>
<a href="en.php"><p style="font-size: 20px;"><strong>English</strong></p></a>
<br>
<br>
<br>
<br>
